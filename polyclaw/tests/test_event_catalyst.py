...
def sample_market_fixture(keyword: str, days: float = 10.0, yes_price: float = 0.55, category: str = 'news'):
    now = utcnow()
...
def test_event_catalyst_rejects_novelty_market():
    ...
    # Novelty markets have conviction reduced, likely below threshold
    # with min_confidence=0.62
    # The signal may still appear if conviction is high enough
    # (novelty reduces by 0.15 but info_event adds 0.1 back)

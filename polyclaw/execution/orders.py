...
class OrderSpec:
    ...
    def to_ctf_payload(self, contract_address: str, signer_address: str) -> dict:
        """
        Build the base payload structure for paper trading.

        Note: Real CTF contract calls use ABI-encoded call data built by
        PolymarketCTFProvider._build_call_data() in providers/ctf.py.
        ...
        Returns:
            A dict suitable for paper trading simulation.
        """
        import uuid
            ...
            "params": [
                {
                    "to": contract_address,
                    "from": signer_address,
                    "data": "0x",  # Paper trading - no real call data needed
